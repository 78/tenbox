...
- **macOS Agent tool archive extraction**: shared-folder mounts may not support preserving file metadata such as mtimes/owners. Extract Agent import and migration archives in the guest `/tmp` and use tar options that avoid restoring unsupported metadata.
